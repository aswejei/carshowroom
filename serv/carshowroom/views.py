...
from serv.carshowroom.serializers import CarShowroomSerializerGet, CarShowroomSerializerPost, \
                                         CustomerShowroomOffersSerializerGet, CustomerShowroomOffersSerializerPost, \
                                         CarPriceRelationShowroomSerializerPost, CarPriceRelationShowroomSerializerGet
...
class CarPriceRelationShowroomViewSet(
                                      SafeDeleteModelMixin,
                                      mixins.ListModelMixin,
                                      mixins.RetrieveModelMixin,
                                      mixins.CreateModelMixin,
...
class CustomerShowroomOfferViewSet(SafeDeleteModelMixin,
    ...
    def get_queryset(self):
        queryset = CustomerShowroomOffers.objects.select_related('customer', 'showroom', 'car')\
                                                 .filter(customer__user=self.request.user.id)
        return queryset
