...
from serv.supplier.models import Car, CarPriceRelationSupplier, Supplier
from serv.supplier.serializers import CarSerializer, \
                                      SupplierSerializerGet,\
                                      SupplierSerializerPost, \
                                      CarPriceRelationSupplierSerializerPost, \
                                      CarPriceRelationSupplierSerializerGet
from serv.core.filters import SupplierFilter, CarFilter, CarPriceRelationSupplierFilter
...
class CarPriceRelationSupplierViewSet(
                                      SafeDeleteModelMixin,
                                      mixins.ListModelMixin,
                                      mixins.RetrieveModelMixin,
                                      mixins.CreateModelMixin,
